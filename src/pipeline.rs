...
use crate::{depth::DepthResources, swapchain::SwapchainData, vertex::Vertex, vulkan_context::VulkanContext};
...
impl PipelineData {
    pub unsafe fn new(vulkan_context: &VulkanContext, swapchain_data: &SwapchainData, depth_resources: &DepthResources) -> Result<Self> {
        ...
        Ok(Self { descriptor_set_layout, pipeline, pipeline_layout, descriptor_pool, descriptor_set })
    }
